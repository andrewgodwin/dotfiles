...
alias flamedramon="ssh -t ubuntu@flamedramon.wyvern-arctic.ts.net -- screen -d -R"
alias charmeleon="mosh andrew@charmeleon.internal.aeracode.org -- bash -c 'tmux attach || tmux new'"
